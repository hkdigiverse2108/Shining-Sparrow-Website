      ...
      <MouseParallax className="elementor-container elementor-column-gap-extended">
        <div
          ...
          <div className="elementor-widget-wrap elementor-element-populated">
            ...
            <div
              className="elementor-element elementor-element-a3eb1de elementor-widget__width-auto elementor-absolute elementor-hidden-tablet_extra elementor-hidden-tablet elementor-hidden-mobile elementor-widget elementor-widget-edublink-animation"
              data-aos="zoom-in"
              data-aos-duration={1200}
            >
              <div className="elementor-widget-container">
              ...
              <div className="elementor-widget-container">
                <div className="edublink-icon-box-wrapper edublink-icon-box-icon edublink-icon-box-icon-position-left">
                  <div className="edublink-icon-box-icon edublink-icon-box-enable">
                    <i aria-hidden="true" className="edublink icon-30" />
                  </div>
                  <div className="edublink-icon-box-content">
                    <h6 className="edublink-icon-box-title">20K+</h6>
            ...
            <div
              className="elementor-element elementor-element-2d5af93 elementor-widget elementor-widget-image"
              data-id="2d5af93"
            ...
            >
              <div className="elementor-widget-container">
                <img
                  ...
                  width={520}
                  height={370}
                  src={`${ImagePath}home/about-03.webp`}
        ...
        <div
          className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-a6adaf3"
          data-id="a6adaf3"
          data-element_type="column"
        >
          <div className="elementor-widget-wrap elementor-element-populated">
            <div
              className="elementor-element elementor-element-a7b238c elementor-widget__width-auto elementor-absolute elementor-hidden-tablet_extra elementor-hidden-tablet elementor-hidden-mobile elementor-widget elementor-widget-edublink-animation"
              data-aos="zoom-in"
              data-aos-duration={1200}
            >
              <div className="elementor-widget-container">
            ...
            <div
              className="elementor-element elementor-element-50e65ac elementor-widget elementor-widget-edublink-heading"
              data-aos="fade-up"
              data-aos-duration={1200}
            >
              <div className="elementor-widget-container">
            ...
            <div
              className="elementor-element elementor-element-2ae1811 edublink-font-secondary elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
              data-aos="fade-up"
              data-aos-duration={1200}
            >
              <div className="elementor-widget-container">
